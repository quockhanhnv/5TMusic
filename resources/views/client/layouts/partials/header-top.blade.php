        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <ul class="list-inline sm-pull-none sm-text-center text-right text-white mb-sm-20 mt-10">
                    <li class="m-0 pl-10"> <a href="{{ asset('template/ajax-load/login-form.html') }}" class="text-white ajaxload-popup"><i class="fa fa-user-o mr-5 text-white"></i> Login /</a> </li>
                    <li class="m-0 pl-0 pr-10">
                        <a href="{{ asset('template/ajax-load/register-form.html') }}" class="text-white ajaxload-popup"><i class="fa fa-edit mr-5"></i>Register</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <nav id="menuzord" class="menuzord default menuzord-responsive">
                        ...
                        <div class="megamenu megamenu-bg-img">
                            <div class="megamenu-row">
                                ...
                                <div class="col3">
                                    ...
                                    <article class="post clearfix">
                                        <div class="entry-header">
                                            <div class="post-thumb"> <img class="img-responsive" src="{{ asset('template/images/blog/1.jpg') }}" alt=""> </div>
                                        </div>
                                ...
                                <div class="col3">
                                    ...
                                    <img src="{{ asset('template/images/megamenu/megamenu-sale-off.jpg') }}" alt="">
                                </div>
                                <div class="col3">
                ...
                <div class="pull-right sm-pull-none mb-sm-15">
                    <a class="btn btn-colored btn-theme-colored2 mt-15 mt-sm-10 pt-10 pb-10 ajaxload-popup" href="{{ asset('template/ajax-load/form-appointment.html') }}">Get a Quote</a>
                </div>
            </nav>
        </div>
    </div>

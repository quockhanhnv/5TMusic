...
<link href="{{ asset('template/images/favicon.png') }}" rel="shortcut icon" type="image/png">
<link href="{{ asset('template/images/apple-touch-icon.png') }}" rel="apple-touch-icon">
<link href="{{ asset('template/images/apple-touch-icon-72x72.png') }}" rel="apple-touch-icon" sizes="72x72">
<link href="{{ asset('template/images/apple-touch-icon-114x114.png') }}" rel="apple-touch-icon" sizes="114x114">
<link href="{{ asset('template/images/apple-touch-icon-144x144.png') }}" rel="apple-touch-icon" sizes="144x144">
...
<link id="menuzord-menu-skins" href="{{ asset('template/css/menuzord-skins/menuzord-rounded-boxed.css') }}" rel="stylesheet"/>
<!-- CSS | Main style file -->
...
<link  href="{{ asset('template/js/revolution-slider/css/settings.css') }}" rel="stylesheet" type="text/css"/>
...
<!-- Plug in -->
<link rel="stylesheet" href="{{ asset('template/plugin/codeseven-toastr/build/toastr.css') }}">

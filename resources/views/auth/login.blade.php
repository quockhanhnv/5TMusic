                            ...
                            <div class="col-md-6 col-md-push-3">
                                ...
                                <div class="widget bg-lightest border-1px p-30">
                                    <div class="widget border-1px p-30">
                                        <h5 class="widget-title line-bottom">Đăng nhập thành viên 5T Guitar</h5>
                                        @if (session('message'))
                                        ...
                                        <form method="POST" action="">
                                            ...
                                            <div class="form-group mb-0 mt-20">
                                                <button type="submit" class="btn btn-dark btn-theme-colored" data-loading-text="Please wait...">Đăng nhập</button>

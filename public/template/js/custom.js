...
(function($) {
    ...
    THEMEMASCOT.initialize = {
        ...
        TM_loadBSParentModal: function() {
            ...
            if( ajaxLoadContent ) {
                console.log('send ajax ajax-load/bootstrap-parent-modal.html')
                // $.ajax({
        ...
        TM_demoSwitcher: function() {
            ...
            if( !$style_switcher.length && showSwitcher ) {
                console.log('send ajax color-switcher/style-switcher.html')
                // $.ajax({
    ...
    THEMEMASCOT.header = {
        ...
        TM_fullscreenMenu: function() {
            var $menufullpage = $('.menu-full-pages .fullpage-nav-toggle');
        ...
        TM_scrolltoTarget: function() {
            //jQuery for pages scrolling feature - requires jQuery Easing plugin
        ...
        TM_beforeAfterSlider: function() {
            ...
            if( $before_after_slider.length > 0 ) {
                $before_after_slider.each(function() {
                    ...
                    $this.twentytwenty({
                        default_offset_pct: data_offset_pct, // How much of the before image is visible when the pages loads
